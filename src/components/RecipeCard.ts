...
export function RecipeCard(recipe: Recipe) {
  ...
  card.classList.add('relative', 'flex', 'flex-col', 'w-[380px]', 'rounded-[21px]')
  ...
  card.innerHTML = `
    ...
    <div class="bg-white h-[478px] px-[25px] pt-[32px] pb-[61px] text-wrap rounded-b-[21px]">
      ...
      <aside
        ...
        class="absolute bg-[#FFD15B] font-manrope text-[12px] text-black w-[63px] h-[26px] rounded-[14px] px-[15px] py-[5px] right-[37px] top-[26px]">${
          recipe.time
        }min</aside>
    </div>
  `
